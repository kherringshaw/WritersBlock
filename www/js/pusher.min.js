...
var pusher = new Pusher('5901f4ac8b275f578afb');

var notificationsChannel = pusher.subscribe('test_channel');

notificationsChannel.bind('my_event', function(notification){
    var message = notification.message;
    $('div.notification').text("MESSAGE IS" + message);
});
